function Details({ data }) {
  return (
    <div>
      <div className="grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 gird-cols-1 justify-center  gap-5 mt-10 mb-10">
        {data.map((item) => {
          return (
            <div
              key={item.id}
              className="bg-white/5 border border-white/10 rounded-xl p-5 m-4 shadow-lg hover:cursor-pointer hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
            >
              ...
              <p className="mb-2 text-gray-300 text-sm leading-relaxed">
                {item.description}
              </p>
